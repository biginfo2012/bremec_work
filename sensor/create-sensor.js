...
const PROFILE = 'bremec';

//constants used in the app - do not change
const SETTINGS_FILE = './settings.json';
const MOBILE_SETTINGS_FILE = './sensor-names.json';
...
var credentials = new AWS.Credentials({accessKeyId: 'AKIA4UQBWUTVHOITDOSN', secretAccessKey: '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'});
